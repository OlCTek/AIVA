...
public class Animation
{
            ...
            throws IOException
    {
        ...
        heightTimeline.play();
        widthTimeline.setOnFinished(e->{ // Plays position timelines after dimension timelines are complete
            xPosTimeline.play();
            yPosTimeline.play();
        });
    }
     ...
     */
     ...
     {
        Timeline widthTimeline = widthAnimation(stage, 231.0, 1.25); // Establishes dimension timelines
     ...
     * General detection of exceptions produced by failed or interrupted I/O operations
     */
    public void travelAnimation(Stage stage, double startPosX, double endPosX, double startPosY, double endPosY)
            throws IOException
    {
        Timeline xPosTimeline = xPosAnimation(stage, startPosX, endPosX); // Establishes position timelines
        Timeline yPosTimeline = yPosAnimation(stage, startPosY, endPosY);
