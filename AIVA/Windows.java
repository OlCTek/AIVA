...
public class Windows {
     ...
     */
    public void showMain(Stage stage, Boolean startup, Boolean login) throws IOException
    {
        ...
        window.setup(stage); // Sets aspects of window stage and displays
     ...
     * @throws IOException General detection of exceptions produced by failed or interrupted I/O operations
     */
    public void show(String fxml, double width, double height) throws IOException
    {
    ...
    void denied() throws IOException
    {
        ...
        delay.play();
        Rectangle2D primaryScreenBounds = Screen.getPrimary().getVisualBounds();
        stage.setX(primaryScreenBounds.getMaxX() - 880);
