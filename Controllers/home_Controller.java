...
public class home_Controller implements Initializable {
     ...
     */
    @FXML
    public void handleFileUser() throws IOException { window.show("/FXML/user_Window.fxml", 242, 182); }
     ...
     */
    @FXML
    public void handleFileSettings() throws IOException { window.show("/FXML/settings_Window.fxml", 140,
            222); }
     ...
     */
    @FXML
    public void handleEditCalibrate() throws IOException { window.show("/FXML/calibrate_Window.fxml", 310,
            310); }
     ...
     */
    @FXML
    public void handleEditTest() throws IOException { window.show("/FXML/test_Window.fxml", 310, 310); }
     ...
     */
    @FXML
    public void handleEditPreferences() throws IOException { window.show("/FXML/preferences_Window.fxml", 310,
            310); }
     ...
     */
    @FXML
    public void handleEditPersonalize() throws IOException { window.show("/FXML/personalize_Window.fxml", 310,
            310); }
     ...
     */
    @FXML
    public void handleEditLayout() throws IOException { window.show("/FXML/layout_Window.fxml", 310,
            310); }
     ...
     */
    @FXML
    public void handleViewThemeLight() throws IOException
    {
     ...
     */
    @FXML
    public void handleViewThemeDark() throws IOException
    {
     ...
     */
    @FXML
    public void handleViewThemeAdd() throws IOException { window.show("/FXML/addTheme_Window.fxml", 310,
            310); }
     ...
     */
    @FXML
    public void handleViewTools() throws IOException { window.show("/FXML/tools_Window.fxml", 310,
            310); }
     ...
     */
    @FXML
    public void handleViewContacts() throws IOException { window.show("/FXML/contacts_Window.fxml", 310,
            310); }
     ...
     */
    @FXML
    public void handleViewLogs() throws IOException { window.show("/FXML/logs_Window.fxml", 310, 310); }
     ...
     */
    @FXML
    public void handleHelpFind() throws IOException { window.show("/FXML/find_Window.fxml", 310, 310); }
     ...
     */
    @FXML
    public void handleHelpCommands() throws IOException { window.show("/FXML/commands_Window.fxml", 310,
            310); }
     ...
     */
    @FXML
    public void handleHelpAbout() throws IOException { window.show("/FXML/about_Window.fxml", 310,
            310); }
