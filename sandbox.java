...
public class sandbox extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        com_submit.setOnAction(e->{
            ...
            else if (user_com.getText().endsWith(".com")) {
        ...
        //Create Login Scene
        Login_scene = new Scene(Login_grid, 235, 115);
    ...
    private GridPane login_gridCreate(String i) {
        ...
        if (i.equals("i")) {
            ...
            GridPane.setConstraints(iuName_prompt, 0, 0);
        }
        ...
        if (i.equals("i")) {
            ...
            GridPane.setConstraints(iuName_in, 1, 0);
        }
        ...
        if (i.equals("i")) {
            ...
            GridPane.setConstraints(iPass_prompt, 0, 1);
        }
        ...
        if (i.equals("i")) {
            ...
            GridPane.setConstraints(iPass_in, 1, 1);
        }
        ...
        if (i.equals("i")) {
            ...
            iLogin_grid.getChildren().addAll(iuName_prompt, iuName_in, iPass_prompt, iPass_in, iSubmit_button,
                    iUser_save);
        }
